...
import com.eggoz.ecommerce.view.product.MoreProductFragment
import com.eggoz.ecommerce.view.product.ProductFragment
import java.text.DecimalFormat

class ProductMoreAdapter(val callback: MoreProductFragment, var result: List<Products.Result?>) :
            ...
            btnAdd.setOnClickListener {
                ...
                callback.itemclick(
                    ...
                    name = result[position]?.name
                        ?: "" + " " + result[position]?.description + " " + result[position]?.sKUCount + " pcs",
